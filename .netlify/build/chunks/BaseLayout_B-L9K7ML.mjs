import { e as createComponent, r as renderTemplate, g as addAttribute, h as createAstro, m as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, k as renderComponent, n as renderScript, o as renderHead, l as renderSlot } from './astro/server_kJpNU5V_.mjs';
import 'piccolore';
import 'clsx';
/* empty css                         */
/* empty css                         */
...
}, "/Users/stefanroets/WebstormProjects/GitHub/my-portfolio-main/src/components/MainHead.astro", void 0);
...
const iconPaths = {
  ...
  "camera-alt": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Camera Alt</title><path fill-rule="evenodd" d="M20 4c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2h3.17L8.4 2.65c.38-.41.92-.65 1.48-.65h4.24c.56 0 1.1.24 1.47.65L16.83 4H20Zm-8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6Zm5-3c0 2.76-2.24 5-5 5s-5-2.24-5-5 2.24-5 5-5 5 2.24 5 5Z"></path><metadata>alt, camera, image, photo, photography, picture</metadata></svg>`,
  "brush": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Brush</title><path fill-rule="evenodd" d="m19.37 3.29 1.34 1.34c.39.39.39 1.02 0 1.41L11.75 15 9 12.25l8.96-8.96a.996.996 0 0 1 1.41 0ZM4 17c0-1.66 1.34-3 3-3s3 1.34 3 3c0 2.21-1.79 4-4 4-1.51 0-3.08-.78-4-2 .84 0 2-.69 2-2Z"></path><metadata>art, brush, design, draw, edit, editing, paint, painting, tool</metadata></svg>`,
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  const iconLinks = [
    {
      label: "GitHub",
      href: "https://github.com/Stefanroets180",
      icon: "github-logo"
    }
  ];
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer data-astro-cid-sz7xmlte> <div class="group" data-astro-cid-sz7xmlte> <p data-astro-cid-sz7xmlte>&copy; ${currentYear} Stefan Roets</p> <p data-astro-cid-sz7xmlte>
Designed & Developed with <a href="https://astro.build/" data-astro-cid-sz7xmlte>Astro</a>${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2em", "data-astro-cid-sz7xmlte": true })} </p> </div> </footer> `;
}, "/Users/stefanroets/WebstormProjects/GitHub/my-portfolio-main/src/components/Footer.astro", void 0);
